...
// APIClient manages communication with the Email Validation API — Enterprise-grade Email Verification API v2.5.0
...
type APIClient struct {
	...
	DeveloperToolsAPI DeveloperToolsAPI

	EmailValidationAPI EmailValidationAPI
	...
	WebhooksManagementAPI WebhooksManagementAPI
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.WebhooksManagementAPI = (*WebhooksManagementAPIService)(&c.common)
